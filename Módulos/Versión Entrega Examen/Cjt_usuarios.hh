...
public:
	...
	*/
	void actualizar_estad_usuario(Cjt_sesiones& se, Cjt_cursos& cu, const string& nombre_us, const string& nombre_prob, int resultado, bool& is);
	...
	*/
	...
	/** @brief Modificadora sobre el conjunto de usuarios
		\pre existe Usuario con identificador "nombre" en el p.i. y está inscrito a algún Curso
		\post Usuario con identificador nombre pasa a estar no inscrito a ningún curso y c = el
		curso al que estaba inscrito
		Curso
	*/
	void acabar_curso_usuario_id(Cjt_cursos& cu, const string& nombre, int& c);
