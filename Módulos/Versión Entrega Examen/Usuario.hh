...
public:
	...
	*/
	void envio_prob(const string& id_prob, int res, Cjt_cursos& cu, Cjt_sesiones& se);
	/** @brief Modificadora del conjunto de usuarios
	...
	*/
	...
	//pre:p.i. esta incrito
	//desuscribe usuairio del curso, b cierto si no queda problma nviable del curso actual
	void desuscribir(bool& b);

	bool prob_is_solved(const string& id);
