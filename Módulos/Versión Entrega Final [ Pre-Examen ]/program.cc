...
int main() {
	...
	while (comando != "fin") {
		...
		//////////////////////////////OPERATION//////////////////////////////
			...
			lista_problemas.actualizar_estad_prob(ident_problma, resultado);
			lista_usuarios.actualizar_estad_usuario(lista_sesiones, lista_cursos, ident_usuario, ident_problma, resultado);
		}
		//////////////////////////////OPERATION//////////////////////////////
